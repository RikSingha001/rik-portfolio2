...
export default function DotVendors() {
  ...
  return (<main > 
    ...
    <div className="flex justify-end p-4 bg-white relative">
      ...
      {open && (
        ...
        <PreviousRiding />
        <UserProfileSession /> */}
        <button type="button"onClick={() => window.location.href = '/vendor-login'} > Logout</button>
      </div>
    </main>
  );
}